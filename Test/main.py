...
# data logger
from excel_logger import ExcelFileHandler  # Assuming you saved the class in excel_logger.py
        ...
        response = requests.post(
            ...
            json={
                "messages": [{
                    "role": "user",
                    "content": [
                        {"type": "text", "text": "Transcribe this Cantonese audio to Traditional Chinese,the number should be the arabic numbers"},
                        {
                            "type": "input_audio",
                            "input_audio": {
                ...
                try:
                    ...
                    def Find_the_cell():
                        ...
                        try:
                            ...
                            for i in ws['C4:AG4'][0]:
                                ...
                                if cell_value in [current_day, current_day_no_zero]:
                                    ...
                                    logger.log_operation(
                                        ...
                                        details={
                                            'column': col,
                                            'search_value': current_time.strftime("%d"),
                            ...
                            for i in ws['A6:A101']:
                                if i[0].value <= current_time.strftime("%H:%M"):
                                    ...
                                    logger.log_operation(
                                        ...
                                        details={
                                            'row': row,
                                            'search_value': current_time.strftime("%H:%M"),
                            ...
                            logger.log_operation(
                                operation="cell_location_failed",
                                file_path=file_path,
                                success=False,
                                error=e
                            )
                    ...
                    write_to_cell(file_path, row, col, "YOUR_VALUE_HERE")
